...
\\
$[2]$ Determine and fill in the missing step in the below key exchange (5 points total).
\begin{enumerate}
    ...
    \item Bob chooses a secret integer, $b$, and computes $B = g^b \mod \underline{\hspace{2cm}}$. He sends $B$ to Alice.
